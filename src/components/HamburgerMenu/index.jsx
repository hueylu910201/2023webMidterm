...
export default function HamMenu({ onClick, isOnTouch }) {
   ...
   return (
      <span onClick={onClick} className={`${styles.hamMenu} ${styles.showMobile}`}>
         <span className={bar1Style} style={{backgroundColor:colorTextBase}}></span>
         <span className={bar2Style} style={{backgroundColor:colorTextBase}}></span>
         <span className={bar3Style} style={{backgroundColor:colorTextBase}}></span>
      </span>
   );
}